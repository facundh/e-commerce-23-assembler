        ...
        {cart ?
          cart.map(({ id, title, price, description, img, quantity }: ProductProps): ReactElement => (
            <>
              ...
              <Card key={id} sx={{ width: { sm: '700px', md: '700px', lg: '700px' }, margin: { xs: '0 auto', sm: '0 auto', md: '0 auto', lg: '0 auto', xl: '0 auto' } }}>
                <CardActionArea sx={{
                  display: { xs: 'flex', sm: 'flex', md: 'flex', flexDirection: 'column', lg: 'flex', xl: 'flex' },
                  marginBottom: 10,
                  width: { xs: '410px', sm: '550px', md: '700px' },
                }}>
                  ...
                  <CardMedia
                    ...
                    sx={{ width: '100px' }}
                  />
                  <CardContent sx={{ display: { sm: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' } }}>
