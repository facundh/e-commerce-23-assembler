...
export const Home: FC<ProductsItemProps> = () => {
  ...
  return (
    <>
      <Container fixed maxWidth="xl" sx={{ display: { sm: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', md: 'flex', lg: '0 auto' } }}>
        <TextField
          hiddenLabel
          ...
          type='text'
        />
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-around', width: '100%' }}>
